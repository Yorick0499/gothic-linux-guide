...
4. Select the **workshop - Workshop Beta** version.
...
The first step is to install **protontricks**, which allows you to easily install various Windows components:
```bash
...
1. Open the game folder and navigate to the system directory. For example:
   ```
   ~/.steam/steam/steamapps/common/Gothic/system
   ```
3. Delete SystemPack.ini
...
4. At the bottom of this subsection, add the following line:
   ...
   ```
6. In the same subsection, find and remove the following line:
   ```ini
    "dsound"="native,builtin"
   ```

## Launch the game
After completing all the steps above, the game should run correctly.
By installing the **workshop - Workshop Beta** version, you also can install various mods and plugins from Steam Workshop, which should work properly as well.

---

## Credits / References
This guide was inspired by a tutorial posted on Reddit: [link](https://www.reddit.com/r/worldofgothic/comments/1omr7h3/gothic_gothic_2_notr_spine_installation_guide_for/)
